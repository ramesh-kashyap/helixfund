            ...
            <div class="col-md-6 col-lg-5">
                <div class="card bento-card">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('submitResetPassword') }}" method="POST" name=mainform 
                            class="login-form">
                                                        {{ csrf_field() }}
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="code" value="" placeholder="enter your verification code " class="form-control"
                                        autofocus="autofocus">
                                </div>
                            </div>
                                <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" name="password" value="" placeholder="enter your new password" class="form-control"
                                        autofocus="autofocus">
                                </div>
                            </div>
                                <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" name="password_confirmation" value="" placeholder="enter your confirm password" class="form-control"
                                        autofocus="autofocus">
                                </div>
                            </div>
