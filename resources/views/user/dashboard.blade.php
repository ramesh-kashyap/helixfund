...
@if (Auth::user()->last_trade != null)
    ...
    <a href="{{ route('user.tradeOn') }}" class="button" style="display: block; width: 100%; max-width: 500px; text-decoration: none;">
        <div class="blob1"></div>
        <div class="blob2"></div>
        <div class="inner" style="background: radial-gradient(circle 80px at 80% -50%, #a020f0, #4b0082); text-align: center; width: 100%;">
            Start Quantization
        </div>
    </a>
</div>              @else
    ...
    <a class="button" style="display: block; width: 100%; max-width: 500px; text-decoration: none;">
        <div class="blob1"></div>
        <div class="blob2"></div>
        <div class="inner" style="background: radial-gradient(circle 80px at 80% -50%,rgb(82, 81, 82),rgb(82, 81, 82)); text-align: center; width: 100%;">
    ...
    <a href="{{ route('user.tradeOn') }}" class="button" style="display: block; width: 100%; max-width: 500px; text-decoration: none;">
        ...
        <div class="inner" style="background: radial-gradient(circle 80px at 80% -50%, #a020f0, #4b0082); text-align: center; width: 100%;">
            Start Quantization
                                ...
                                @if ($trade === true)
                                     <div id="zscooProcess" class="quantify-execute mt-4" style="display: block; width: 100%; max-width: 500px;">
            <div class="process-box">
                <h3 style="font-size: 16px;">@lang('Helix Fund Run Panel Process') <span class="spinner">⏳</span></h3>
                <div id="stepsLog"></div>
            </div>
        </div>
...
// Show the popup by setting display to bloc
 ...
 setTimeout(() => {
            location.reload();  // ⬅️i this refreshes the page
        }, 3000);
