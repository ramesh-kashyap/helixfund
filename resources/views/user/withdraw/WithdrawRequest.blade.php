...
<form action="" method=post onsubmit="return checkform()" name=editform><input type="hidden" name="form_id" value="17471381997351"><input type="hidden" name="form_token" value="ad6f6f901f740d242b22a76492bea608">
...
<style>
  ...
  <input type=password name=password value="" class="form-control" size=30>
        </div>
        <div class="mb-3">
    ...
    <!-- <div class="col-md-12 mb-3">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <input type=text class="form-control" size=30 name="pay_account[48]"
          ...
          <input type=text class="form-control" size=30 name="pay_account[68]"
              value="" data-validate="regexp"
          ...
          <input type=text class="form-control" size=30 name="pay_account[85]"
              value="" data-validate="regexp"
          ...
          <input type=text class="form-control" size=30 name="pay_account[92]"
              value="" data-validate="regexp"
              data-validate-regexp="^T[a-km-zA-HJ-NP-Z1-9]{25,34}$"
          ...
          <input type=text class="form-control" size=30 name="pay_account[102]"
              value="" data-validate="regexp"
